  ...
  return (
          <div className="overflow-hidden w-64 h-screen bg-gray-800 py-4 px-3 bg-gray-50 dark:bg-gray-800" aria-label="Sidebar">
            <ul className="space-y-5">
              ...
              <li>
                <a href="index" className="flex items-center p-2 w-64 text-base bg-red-700 font-normal text-white hover:bg-red-700">
              ...
              <li>
                <a href="about" className="flex items-center p-2 bg-blue-900 text-base font-normal text-white hover:bg-red-700">
