...
const upload_url = 'http://192.168.1.2:3333/api/image/uploadone';
const freshness_url = 'http://192.168.1.2:3333/api/calcfreshness/predict';
const add_task = 'http://192.168.1.2:3333/api/tasks/createtask';
