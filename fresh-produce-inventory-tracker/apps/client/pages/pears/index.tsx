...
const options = [
  "Pears","All","Apples","Grapes","Oranges"
];
...
export function Apples({fruitDataMonday,fruitDataTuesday,fruitDataWednesday,fruitDataThursday,fruitDataFriday,fruitDataSaturday,fruitDataSunday},props:InventoryProps) { 
  ...
  const filter = async (event) => {
    ...
    else if(event.target.values != "Pears")
    {
  ...
  return (
      ...
      <Chart type="Line" fruit="Pears" dataMonday={fruitDataMonday} dataTuesday={fruitDataTuesday} dataWednesday={fruitDataWednesday} dataThursday={fruitDataThursday} dataFriday={fruitDataFriday} dataSaturday={fruitDataSaturday} dataSunday={fruitDataSunday}></Chart>
    </div>
  );
}
