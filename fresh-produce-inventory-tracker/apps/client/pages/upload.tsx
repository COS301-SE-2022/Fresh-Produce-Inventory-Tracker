export function Index() {
    return (
        <div className="w-64 h-screen border-solid border-2 border-black bg-gray-800" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 px-3 bg-gray-50 dark:bg-gray-800">
              <ul className="space-y-5">
                ...
                <li>
                  <a href="upload" className="flex items-center p-2 text-base bg-red-700 font-normal text-white hover:bg-red-700">
                    <i className="fa fa-upload" style={{fontSize: '48px'}} />
                    <span className="ml-3">Upload Photos</span>
                  </a>
                </li>
                <li>
                  <a href="" className="flex items-center p-2 text-base bg-blue-900 font-normal text-white hover:bg-red-700">
                    <i className="fa fa-user" style={{fontSize: '48px'}} />
                    <span className="ml-3">User Info</span>
                  </a>
                </li>
                <li>
                  <a href="" className="flex items-center p-2 bg-blue-900 text-base font-normal text-white hover:bg-red-700">
