...
const options = [
  "Oranges","All","Apples","Pears","Grapes"
];
...
export function Apples({fruitDataMonday,fruitDataTuesday,fruitDataWednesday,fruitDataThursday,fruitDataFriday,fruitDataSaturday,fruitDataSunday},props:InventoryProps) { 
  ...
  const filter = async (event) => {
    ...
    else if(event.target.value != "Oranges")
    {
  ...
  return (
      ...
      <Chart type="Line" fruit="Oranges" dataMonday={fruitDataMonday} dataTuesday={fruitDataTuesday} dataWednesday={fruitDataWednesday} dataThursday={fruitDataThursday} dataFriday={fruitDataFriday} dataSaturday={fruitDataSaturday} dataSunday={fruitDataSunday}></Chart>
    </div>
  );
}
